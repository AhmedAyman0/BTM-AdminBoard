...
const NavBar = ()=>{
    ...
    <Link style={aStyle} className="navbar-brand" >Weight Tracker</Link>
    ...
    <div id="navb" className="navbar-collapse collapse hide">
      <ul className="navbar-nav">
        ...
        <li  className="nav-item">
            <Link className="nav-link active" >My History </Link> 
          </li>
      ...
      <ul  className="nav navbar-nav ml-auto">
          ...
          <li className="nav-item">
              <Link className="nav-link" ><span className="fas fa-sign-in-alt"></span> Sign Out </Link>
          </li>
        </ul>
    </div>
  </nav>
